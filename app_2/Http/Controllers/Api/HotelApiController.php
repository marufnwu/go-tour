...
class HotelApiController extends Controller
{
    public function index (Request $request){
        ...
        $hotelR = $tour ? Reservation::where('tourleader_tour_id', $tour->id)->get() : [];
        
        $reservations = $this->getReservation($hotelR);
        ...
        foreach ($hotels as $hotelItem){
            ...
            $singleHotel = array(
                ...
                'fromD' => $hotelRes ? $hotelRes->from_date : null,
                'toD' => $hotelRes ? $hotelRes->to_date : null
    ...
    public function getReservation($hotelR)
    {
        $reservations = array();
