...
class TourLeaderTourController extends Controller
{
    ...
    public function index()
    {
        ...
        //     $tour_room->tour_id = $tour->id;
        //     $tour_room->rtc_data = json_encode(array());
        //     $tour_room->is_active = false;
    ...
    public function create()
    {
        ...
        $languages = array(
            ...
            "Bulgarian - български",
            "Catalan - català",
            "Central Kurdish - کوردی (دەستنوسی عەەبی)",
            "Chinese - 中文",
    ...
    {
        $tours = Tourleadertour::find($id);
        $tourRoom = TourRoom::where('tour_id',$tours->id)->first();
