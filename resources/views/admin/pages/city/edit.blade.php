...
@section('title','Manage City | Edit')
        ...
        <div class="card shadow mb-4">
            <div class="card-header bg-primary py-3 d-flex justify-content-between align-items-center">
                <h6 class="m-0 font-weight-bold text-white">
                    <i class="fas fa fa-desktop"></i> Edit City
                </h6>

            </div>
            <form id="ajaxForm" class="" action="{{route('city.update',$cities->id)}}" method="POST">
                @csrf
                @method('put')
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input id="from" type="text" class="form-control form-margin-bottom" name="city_name" value="{{ $cities->city_name }}"  placeholder="">
                                @error('city_name')
