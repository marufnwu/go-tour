    ...
    <div class="container-fluid">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('fee.index') }}">Hote prices</a></li>
                <li class="breadcrumb-item active" aria-current="page">Add Hotel price</li>
            </ol>
        </nav>
        ...
        <div class="card shadow mb-4">
            <div class="card-header bg-default py-2 d-flex justify-content-between align-items-center">
                <h4 class="m-0 font-weight-bold text-primary">
                    <i class="fas fa-user-circle"></i>  Add Hotel price
                </h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="from" type="number" min="0" class="form-control form-margin-bottom" name="price" value="{{ old('price') }}"  placeholder="price...">
                                @error('price')
