        ...
        <div class="card shadow mb-4">
            <div class="card-header bg-default py-2 d-flex justify-content-between align-items-center">
                <h4 class="m-0 font-weight-bold text-primary">
                    <i class="fas fa-user-circle"></i>  Add Operator
                </h4>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group ">
                                ...
                                <input id="from" type="text" class="form-control form-margin-bottom" name="name" value="{{ old('name') }}"  placeholder="Operator name...">
                                @error('name')
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input id="from" type="number" min="0" class="form-control form-margin-bottom" name="phone" value="{{ old('phone') }}" placeholder="operator phone...">
                                @error('phone')
                                    <span class="input-error">{{$message}}</span>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input id="from" type="email" class="form-control form-margin-bottom" name="email" value="{{ old('email') }}" placeholder="Operator email...">
                                @error('email')
                                    <span class="input-error">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input id="from" type="password" class="form-control form-margin-bottom" name="password" value=""  placeholder="Operator password...">
                                @error('password')
                                    <span class="input-error">{{$message}}</span>
                                @enderror
                            </div>
