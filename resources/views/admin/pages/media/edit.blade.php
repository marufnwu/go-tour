    ...
    <div class="container-fluid">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('media.index') }}">Media Type</a></li>
                <li class="breadcrumb-item active" aria-current="page">Edit Media Type</li>
            </ol>
        </nav>
        ...
        <div class="card shadow mb-4">
            <div class="card-header bg-primary py-3 d-flex justify-content-between align-items-center">
                <h6 class="m-0 font-weight-bold text-white">
                    <i class="fas fa fa-desktop"></i> Edit Media
                </h6>

            </div>
            <form id="ajaxForm" class="" action="{{route('media.update',$medias->id)}}" method="POST">
                @csrf
                @method('put')
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="name" class="font-weight-bold">Media Type Name <span class="text-danger">*</span></label>
                                <input id="name" type="text" class="form-control" name="media_type_name" value="{{ $medias->media_type_name }}"  placeholder="">
