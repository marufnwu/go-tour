...
@section('title','Admin | Add Supplier Type')
    ...
    <div class="container-fluid">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Add Supplier Type</li>
            </ol>
        </nav>
        ...
        <div class="card shadow mb-4">
            <div class="card-header bg-default py-2 d-flex justify-content-between align-items-center">
                <h4 class="m-0 font-weight-bold text-primary">
                    <i class="fas fa-user-circle"></i>  Add Supplier Type
                </h4>

            </div>
            <form id="ajaxForm" class="" action="{{route('type_supplier.store')}}" method="POST">
            @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input id="from" type="text" class="form-control form-margin-bottom" name="supplier_type" value="{{ old('supplier_type') }}"  placeholder="Supplier Type...">
                                @error('supplier_type')
