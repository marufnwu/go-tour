...
@section('title','Admin | Add Transportation Cost')
    ...
    <div class="container-fluid">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Add Transportation Cost</li>
            </ol>
        </nav>
        ...
        <div class="card shadow mb-4">
            <div class="card-header bg-default py-2 d-flex justify-content-between align-items-center">
                <h4 class="m-0 font-weight-bold text-primary">
                    <i class="fas fa-user-circle"></i>  Add Transportation Cost
                </h4>

            </div>
            <form id="ajaxForm" class="" action="{{route('cost_transport.store')}}" method="POST">
            @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-4">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <select class="form-control form-margin-bottom" name="car_type_id">
                                    ...
                                    @foreach ($cars as $car)
                                      <option value="{{ $car->id }}">{{ $car->type_name }}</option>
                                    @endforeach
                                </select>
                                @error('car_type_id')
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="from" type="number" min="0" class="form-control form-margin-bottom" name="cost" value="{{ old('cost') }}"  placeholder="Transportation Cost...">
                                @error('cost')
