    ...
    <div class="container-fluid">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('cartype.index') }}">Car Type</a></li>
        ...
        <div class="card shadow mb-4">
            <div class="card-header bg-primary py-3 d-flex justify-content-between align-items-center">
                <h6 class="m-0 font-weight-bold text-white">
                    <i class="fas fa fa-desktop"></i> Edit Car Type
                </h6>

            </div>
            <form id="ajaxForm" class="" action="{{route('cartype.update',$types->id)}}" method="POST">
                @csrf
                @method('put')
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="name" class="font-weight-bold">Car Type<span class="text-danger">*</span></label>
                                <input id="name" type="text" class="form-control form-margin-bottom" name="type_name" value="{{ $types->type_name }}"  placeholder="Car type...">
                                @error('type_name')
                                    <span class="input-error">{{$message == 'The type name field is required.' ? 'The car type is required' : $message;}}</span>
                                @enderror
                            </div>
                        </div>
                    </div>
