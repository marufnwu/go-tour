    ...
    <div class="container-fluid">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Manage Car Type</li>
            </ol>
        </nav>
        ...
        <div class="card shadow mb-4">
            <div class="card-header bg-default py-2 d-flex justify-content-between align-items-center">
                <h4 class="m-0 font-weight-bold text-primary">
                    <i class="fas fa-user-circle"></i> Manage transportation Type
                </h4>
                <a href="{{ route('cartype.create') }}" class="d-none d-sm-inline-block btn btn-primary shadow-sm btn-rounded" >
                        ...
                        @foreach($types as $type)
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a class="btn btn-success btn-sm" href="{{ route('cartype.edit',$type->id) }}">
                                        <i class="fas fa-edit"></i>
                                    </a>

                                    <form class="deleteform d-inline-block" action="{{route('cartype.destroy',$type->id)}}" method="post">
                                        @csrf
                                        @method('delete')
