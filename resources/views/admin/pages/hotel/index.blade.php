        ...
        <div class="card shadow mb-4">
            <div class="card-header bg-default py-2 d-flex justify-content-between align-items-center">
                <h4 class="m-0 font-weight-bold text-primary">
                    <i class="fas fa-user-circle"></i> Hotel
                </h4>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-sm js-dt" id="dataTable" width="100%" cellspacing="0">
                        ...
                        @foreach($hotels as $hotel)
                            <tr>
                                <td>
                                    <img src="{{ asset('/uploads/hotel-profile/'.$hotel->image) }}" height="60" class="rounded" alt="Profile image">
                                </td>
                                ...
                                <td class="text-center">
                                    ...
                                    <a class="btn btn-success btn-sm" href="{{ route('hotel.edit',$hotel->id) }}">
                                        <i class="fas fa-edit"></i>
                                    </a>

                                    <form class="deleteform d-inline-block" action="{{route('hotel.destroy',$hotel->id)}}" method="post">
                                        @csrf
                                        @method('delete')
