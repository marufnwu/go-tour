        ...
        <div class="card shadow mb-4">
            <div class="card-header bg-default py-2 d-flex justify-content-between align-items-center">
                <h4 class="m-0 font-weight-bold text-primary">
                    <i class="fas fa-user-circle"></i>  Add Hotel
                </h4>

            </div>
            <form id="ajaxForm" class="" action="{{route('hotel.store')}}" method="POST" enctype="multipart/form-data">
            @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input id="from" type="text" class="form-control form-margin-bottom" name="hotel_name" value="{{ old('hotel_name') }}"  placeholder="hotel name...">
                                @error('hotel_name')
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input id="from" type="text" class="form-control form-margin-bottom" name="hotel_address" value="{{ old('hotel_address') }}"  placeholder="hotel address...">
                                @error('hotel_address')
                                    <span class="input-error">{{$message}}</span>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="from" type="text" class="form-control form-margin-bottom" name="hotel_city" value="{{ old('hotel_city') }}"  placeholder="hotel city...">
                                @error('hotel_city')
                                    <span class="input-error">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="from" type="email" class="form-control form-margin-bottom" name="hotel_email" value="{{ old('hotel_email') }}"  placeholder="hotel email...">
                                @error('hotel_email')
                                    <span class="input-error">{{$message}}</span>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="from" type="number" class="form-control form-margin-bottom" name="hotel_phone" value="{{ old('hotel_phone') }}"  placeholder="hotel phone...">
                                @error('hotel_phone')
                                    <span class="input-error">{{$message}}</span>
                                @enderror
                            </div>
