...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <form id="ajaxForm" class="" action="{{route('itinerary.store')}}" method="POST">
            @csrf
            <div class="card-body">
                <div class="row">
                ...
                <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <select class="form-control form-margin-bottom js-gen-itinerary" name="gti_id" onchange="loadActivities(this,{{$activities}}); loadDays(this,{{$gtis}})">
                  ...
                  <div class="col-lg-4">
                    <div class="form-group">
                        ...
                        <select id="gti_day" name="day_itinerary" class="form-control form-margin-bottom js_day_itinerary">
                        </select>
                        @error('day_itinerary')
...
<div class="col-lg-4">
    <div class="form-group">
        ...
        <input id="from" type="number" min="0" class="form-control form-margin-bottom" name="position" value="{{ old('position') }}"  placeholder="Position...">
        @error('position')
        <span class="input-error">{{$message}}</span>
        @enderror
    </div>
