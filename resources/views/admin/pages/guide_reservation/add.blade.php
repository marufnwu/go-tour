...
@section('title','Admin | Add Guide Reservation')
    ...
    <div class="container-fluid">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Add Guide Reservation</li>
            </ol>
        </nav>
        ...
        <div class="card shadow mb-4">
            <div class="card-header bg-default py-2 d-flex justify-content-between align-items-center">
                <h4 class="m-0 font-weight-bold text-primary">
                    <i class="fas fa-user-circle"></i>  Add Guide Reservation
                </h4>

            </div>
            <form id="ajaxForm" class="" action="{{route('reserve_guide.store')}}" method="POST">
            @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <select class="form-control form-margin-bottom" name="guide_id">
                                    <option value="">Select Guide</option>
                                    @foreach ($guides as $guide)
                                      <option value="{{ $guide->id }}">{{ $guide->guide_first_n .' '. $guide->guide_l_name}}</option>
                                    @endforeach
                                </select>
                                @error('guide_id')
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="from" type="date" class="form-control form-margin-bottom" name="reservation_date" value="{{ old('reservation_date') }}">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="from" type="date" class="form-control form-margin-bottom" name="from_date" value="{{ old('from_date') }}">
                                @error('from_date')
                                    <span class="input-error">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="from" type="date" class="form-control form-margin-bottom" name="to_date" value="{{ old('to_date') }}">
                                @error('to_date')
                                    <span class="input-error">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="from" type="date" class="form-control form-margin-bottom" name="confirm_date" value="{{ old('confirm_date') }}">
                               @error('confirm_date')
                                    <span class="input-error">{{$message}}</span>
                                @enderror
                            </div>
