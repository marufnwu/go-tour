...
@section('title','Admin | Add Payment Method')
    ...
    <div class="container-fluid">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('method_payment.index') }}">Payment Method</a></li>
        ...
        <div class="card shadow mb-4">
            <div class="card-header bg-default py-2 d-flex justify-content-between align-items-center">
                <h4 class="m-0 font-weight-bold text-primary">
                    <i class="fas fa-user-circle"></i>  Add Payment Method
                </h4>

            </div>
            <form id="ajaxForm" class="" action="{{route('method_payment.store')}}" method="POST">
            @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="" class="font-weight-bold">Payment Method<span class="text-danger">*</span></label>
                                <input id="from" type="text" class="form-control form-margin-bottom" name="payment_method" value="{{ old('payment_method')}}"  placeholder="Payment method...">
