        ...
        <div class="card shadow mb-4">
            <div class="card-header bg-default py-2 d-flex justify-content-between align-items-center">
                <h4 class="m-0 font-weight-bold text-primary">
                    <i class="fas fa-user-circle"></i> Payment Method
                </h4>
                <a href="{{ route('method_payment.create') }}" class="d-none d-sm-inline-block btn btn-primary shadow-sm btn-rounded" >
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-sm js-dt" id="dataTable" width="100%" cellspacing="0">
                        <thead>
                        <tr>
                            <th class="align-text-top">Payment Method</th>
                        ...
                        @foreach($methods as $method)
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a class="btn btn-success btn-sm" href="{{ route('method_payment.edit',$method->id) }}">
                                        <i class="fas fa-edit"></i>
                                    </a>

                                    <form class="deleteform d-inline-block" action="{{route('method_payment.destroy',$method->id)}}" method="post">
                                        @csrf
                                        @method('delete')
