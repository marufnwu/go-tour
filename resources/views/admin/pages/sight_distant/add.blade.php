...
@section('title','Admin | Add Distant Sight')
    ...
    <div class="container-fluid">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('sight_distant.index') }}">Manage Sight distance</a></li>
                <li class="breadcrumb-item active" aria-current="page">Add sight distance</li>
            </ol>
        </nav>
        ...
        <div class="card shadow mb-4">
            <div class="card-header bg-default py-2 d-flex justify-content-between align-items-center">
                <h4 class="m-0 font-weight-bold text-primary">
                    <i class="fas fa-user-circle"></i>  Add Sight Distance
                </h4>

            </div>
            <form id="ajaxForm" class="" action="{{route('sight_distant.store')}}" method="POST">
            @csrf
              <div class="card-body">
                  <div class="row">
                      <div class="col-lg-4">
                          <div class="form-group">
                              <label for="" class="font-weight-bold">Sight distance name<span class="text-danger">*</span></label>
                              <input id="from" type="text" class="form-control form-margin-bottom" name="distant_sight_name" value="{{ old('distant_sight_name') }}"  placeholder="sight distance name...">
                  ...
                  <div class="row">
                    <div class="col-lg-4">
                      <div class="form-group">
                          ...
                          <select class="form-control form-margin-bottom" name="first_site">
                            <option value="{{ old('first_site') }}">Select One</option>
                            @foreach ($sights as $sight)
                              <option value="{{ $sight->sight_name }}">{{ $sight->sight_name }}</option>
                            @endforeach
                        </select>
                        @error('first_site')
                    ...
                    <div class="col-lg-4">
                      <div class="form-group">
                          ...
                          <select class="form-control form-margin-bottom" name="second_site">
                            <option value="{{ old('second_site') }}">Select One</option>
                            @foreach ($sights as $sight)
                              <option value="{{ $sight->sight_name }}">{{ $sight->sight_name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-lg-4">
                      <div class="form-group">
                          <label for="" class="font-weight-bold">Sight Distance (Min)<span class="text-danger">*</span></label>
                          <input id="to" type="text" class="form-control form-margin-bottom" name="sight_distant" value="{{ old('sight_distant') }}"  placeholder="Sight distance...">
                            @error('sight_distant')
