        ...
        <div class="card shadow mb-4">
            <div class="card-header bg-default py-2 d-flex justify-content-between align-items-center">
                <h4 class="m-0 font-weight-bold text-primary">
                    <i class="fas fa-user-circle"></i>  Add Country
                </h4>

            </div>
            <form id="ajaxForm" class="" action="{{route('country.store')}}" method="POST">
            @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-4">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="" class="font-weight-bold">Time Zone<span class="text-danger">*</span></label>
                        ...
                        <div class="col-lg-4">
                          <div class="form-group">
                              <label for="" class="font-weight-bold">Country Code<span class="text-danger">*</span></label>
                              <select class="form-control form-margin-bottom js-gen-itinerary" name="code">
                                    <option value="">Select Country Code...</option>
                                    @foreach ($country_phones as $key => $phone)
                                        <option value="{{ $phone }}">{{$key}} (+ {{ $phone }})</option>
                                    @endforeach
                                </select>
                            @error('code')
