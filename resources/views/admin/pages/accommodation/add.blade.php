...
@section('title','Admin | Add Accommodation')
        ...
        <div class="card shadow mb-4">
            <div class="card-header bg-default py-2 d-flex justify-content-between align-items-center">
                <h4 class="m-0 font-weight-bold text-primary">
                    <i class="fas fa-user-circle"></i>  Add Accommodation
                </h4>

            </div>
            <form id="ajaxForm" class="" action="{{route('accommodation.store')}}" method="POST">
            @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input id="from" type="text" class="form-control form-margin-bottom" name="accommodation_type_name" value="{{ old('accommodation_type_name') }}"  placeholder="accommodation type...">
