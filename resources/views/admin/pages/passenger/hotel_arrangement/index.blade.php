...
@section('title','Admin | Hotel Arrangement')
    ...
    <div class="container-fluid">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Hotel Arrangement</li>
            </ol>
        </nav>
        ...
        <div class="card shadow mb-4">
            <div class="card-header bg-default py-2 d-flex justify-content-between align-items-center">
                <h4 class="m-0 font-weight-bold text-primary">
                    <i class="fas fa-user-circle"></i> Hotel Arrangement
                </h4>
                <!-- <a href="{{ route('hotel_arrangement.create') }}" class="d-none d-sm-inline-block btn btn-primary shadow-sm btn-rounded" >
                    <i class="fa fa-plus"></i>&nbsp; Add Hotel Arrangement </a> -->
            </div>
            <div class="card-body">
                <div class="row">
                    ...
                    <table class="table table-bordered table-sm js-dt" id="dataTable" width="100%" cellspacing="0">
                        ...
                        @foreach($hotels as $hotel)
                            <tr>
                                ...
                                <td>{{ date_format(date_create($hotel->from_date), 'd M Y h:i A') }}</td>
                                <td>{{ date_format(date_create($hotel->to_date), 'd M Y h:i A') }}</td>
