    ...
    <div class="container-fluid">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Add Sight</li>
            </ol>
        </nav>
        ...
        <div class="card shadow mb-4">
            <div class="card-header bg-default py-2 d-flex justify-content-between align-items-center">
                <h4 class="m-0 font-weight-bold text-primary">
                    <i class="fas fa-user-circle"></i>  Add Sight
                </h4>

            </div>
            <form id="ajaxForm" class="" action="{{route('sight_list.store')}}" method="POST">
            @csrf
              <div class="card-body">
                  <div class="row">
                      <div class="col-lg-4">
                          <div class="form-group">
                              ...
                              <input id="from" type="text" class="form-control form-margin-bottom" name="sight_name" value="{{ old('sight_name') }}"  placeholder="Sight name...">
                            @error('sight_name')
                  ...
                  <div class="row">
                    <div class="col-lg-4">
                      <div class="form-group">
                          ...
                          <input id="to" type="email" class="form-control form-margin-bottom" name="email" value="{{ old('email') }}"  placeholder="Sight email...">
                        @error('email')
                            <span class="input-error">{{$message}}</span>
                        @enderror
                      </div>
                    ...
                    <div class="col-lg-4">
                      <div class="form-group">
                          ...
                          <input id="to" type="text" class="form-control form-margin-bottom" name="entrance_fees" value="{{ old('entrance_fees') }}"  placeholder="entrance fees...">
                        @error('entrance_fees')
                            <span class="input-error">{{$message}}</span>
                        @enderror
                      </div>
                    ...
                    <div class="col-lg-4">
                      <div class="form-group">
                          ...
                          <input id="to" type="text" class="form-control form-margin-bottom" name="national_pass" value="{{ old('national_pass') }}"  placeholder="National Pass...">
                        @error('national_pass')
                            <span class="input-error">{{$message}}</span>
                        @enderror
                      </div>
                  ...
                  <div class="row">
                    <div class="col-lg-4">
                        <div class="form-group">
                            <label for="" class="font-weight-bold">Sight Phone<span class="text-danger">*</span></label>
                            <input id="to" type="tel" class="form-control form-margin-bottom" name="phone" value="{{ old('phone') }}"  placeholder="Sight phone...">
                            @error('phone')
                    ...
                    <div class="col-lg-4">
                      <div class="form-group">
                          ...
                          <input id="to" type="text" class="form-control form-margin-bottom" name="description" value="{{ old('description') }}"  placeholder="">
                        @error('description')
                            <span class="input-error">{{$message == 'The country id field is required.' ? 'The country is required' : $message;}}</span>
                        @enderror
                      </div>
