...
@section('title','Admin | Manage Destination Categories')
    ...
    <div class="container-fluid">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Manage Destination Categories</li>
            </ol>
        </nav>
        ...
        <div class="card shadow mb-4">
            <div class="card-header bg-default py-2 d-flex justify-content-between align-items-center">
                <h4 class="m-0 font-weight-bold text-primary">
                    <i class="fas fa-user-circle"></i> Manage Destination Categories
                </h4>
                <a href="{{ route('destination-category.create') }}" class="d-none d-sm-inline-block btn btn-primary shadow-sm btn-rounded" >
            ...
            <div class="card-body">
                ...
                @include("admin.pages.tour_management.category.table", ["items"=>$categories])
            </div>
        </div>
    </div>
