        ...
        @foreach($items as $item)
            <tr>
                ...
                <td class="text-center">
                    ...
                    <a class="btn btn-success btn-sm" href="{{ route('destination.edit',$item->id) }}">
                        <i class="fas fa-edit"></i>
                    </a>

                    <form class="deleteform d-inline-block" action="{{route('destination.destroy',$item->id)}}" method="post">
                        @csrf
                        @method('delete')
