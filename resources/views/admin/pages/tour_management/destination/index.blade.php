        ...
        <div class="card shadow mb-4">
            <div class="card-header bg-default py-2 d-flex justify-content-between align-items-center">
                <h4 class="m-0 font-weight-bold text-primary">
                    <i class="fas fa-user-circle"></i> Manage Destination
                </h4>
                <a href="{{ route('destination.create') }}" class="d-none d-sm-inline-block btn btn-primary shadow-sm btn-rounded" >
            ...
            <div class="card-body">
                ...
                @include("admin.pages.tour_management.destination.table", ["items"=>$destinations])
            </div>
        </div>
    </div>
