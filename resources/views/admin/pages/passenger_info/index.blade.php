    ...
    <div class="container-fluid">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Passenger Information</li>
            </ol>
        </nav>
        ...
        <div class="card shadow mb-4">
            <div class="card-header bg-default py-2 d-flex justify-content-between align-items-center">
                <h4 class="m-0 font-weight-bold text-primary">
                    <i class="fas fa-user-circle"></i> Passenger Information
                </h4>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-sm js-dt" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <th class="align-text-top">Nationality</th>
                            <th class="align-text-top">Birth Date</th>
                        ...
                        {{-- @dd($passenger->special_request) --}}
                            <tr>
                                <td>
                                    <img src="{{ asset('/uploads/passenger-profile/'.$passenger->image) }}" height="60" class="rounded" alt="Profile image">
                                </td>
                                <td>{{ $passenger->first_name }} {{ $passenger->middle_name }} {{ $passenger->last_name }}</td>
                                <td>{{ $passenger->nationality }}</td>
                                <td>{{ date_format(date_create($passenger->birth_date), 'd M Y') }}</td>
                                ...
                                <td class="text-center">
                                    ...
                                    <a class="btn btn-success btn-sm mb-1" href="{{ route('passenger.edit',$passenger->id) }}">
