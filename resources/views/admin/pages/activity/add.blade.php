    ...
    <div class="container-fluid">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('activity.index') }}">Manage Activity</a></li>
        ...
        <div class="card shadow mb-4">
            <div class="card-header bg-default py-2 d-flex justify-content-between align-items-center">
                <h4 class="m-0 font-weight-bold text-primary">
                    <i class="fas fa-user-circle"></i>  Add Activity
                </h4>

            </div>
            <form id="ajaxForm" class="" action="{{route('activity.store')}}" method="POST">
            @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="" class="font-weight-bold">related GTI<span class="text-danger">*</span></label>
                                <select class="form-control form-margin-bottom" name="gti">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="" class="font-weight-bold">Activity Name<span class="text-danger">*</span></label>
                                <textarea id="from" class="form-control form-margin-bottom" name="activity_name" placeholder="Activity Name..." style="resize: none;">{{ old('activity_name') }}</textarea>
                                @error('activity_name')
                                    <span class="input-error">{{$message}}</span>
                                @enderror
                            </div>
