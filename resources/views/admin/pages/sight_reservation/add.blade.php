    ...
    <div class="container-fluid">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Add Sight Reservation</li>
            </ol>
        </nav>
        ...
        <div class="card shadow mb-4">
            <div class="card-header bg-default py-2 d-flex justify-content-between align-items-center">
                <h4 class="m-0 font-weight-bold text-primary">
                    <i class="fas fa-user-circle"></i>  Add Sight Reservation
                </h4>

            </div>
            <form id="ajaxForm" class="" action="{{route('sight_reservation.store')}}" method="POST">
            @csrf
              <div class="card-body">
                <div class="row">
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <input id="from" type="text" class="form-control form-margin-bottom" name="sight_reservation" value="{{ old('sight_reservation') }}"  placeholder="">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <select class="form-control form-margin-bottom" name="sight_id">
                              <option value="{{ old('sight_id') }}">Select Sight</option>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <select class="form-control form-margin-bottom" name="tour_leader_tour_id">
                              <option value="{{ old('tour_leader_tour_id') }}">Select Tour Leader Tour</option>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <input id="to" type="date" class="form-control form-margin-bottom" name="reservation_date" value="{{ old('reservation_date') }}"  placeholder="">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <input id="to" type="date" class="form-control form-margin-bottom" name="confirmation_date" value="{{ old('confirmation_date') }}"  placeholder="">
