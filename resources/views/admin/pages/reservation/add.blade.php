...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            ...
            <form id="ajaxForm" class="" action="{{route('reservation.store')}}" method="POST">
            @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <select class="form-control form-margin-bottom" name="hotel_id">
                                    <option value="{{ old('hotel_id') }}">Select Hotel</option>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <p id="passengers" class="form-margin-bottom" style="margin-top: 6px;"></p>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="to" type="number" min="0" class="form-control form-margin-bottom" name="single_room" value="{{ old('single_room') }}"  placeholder="Total single room...">
                                @error('single_room')
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="to" type="number" min="0" class="form-control form-margin-bottom" name="double_room" value="{{ old('double_room') }}"  placeholder="Total double room...">
                                @error('double_room')
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="to" type="number" min="0" class="form-control form-margin-bottom" name="triple_room" value="{{ old('triple_room') }}"  placeholder="Total triple room...">
                                @error('triple_room')
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="to" type="number" min="0" class="form-control form-margin-bottom" name="single_room_price" value="{{ old('single_room_price') }}"  placeholder="Single room price...">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="to" type="number" min="0" class="form-control form-margin-bottom" name="double_room_price" value="{{ old('double_room_price') }}"  placeholder="Double room price...">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="to" type="number" min="0" class="form-control form-margin-bottom" name="triple_room_price" value="{{ old('triple_room_price') }}"  placeholder="Triple room price...">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input id="to" type="date" class="form-control form-margin-bottom" name="from_date" value="{{ old('from_date') }}"  placeholder="From date...">
                                @error('from_date')
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input id="to" type="date" class="form-control form-margin-bottom" name="to_date" value="{{ old('to_date') }}"  placeholder="To date...">
                                @error('to_date')
                                    <span class="input-error">{{$message;}}</span>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input id="to" type="date" class="form-control form-margin-bottom" name="reservation_date" value="{{ old('reservation_date') }}"  placeholder="Reservation date...">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input id="to" type="date" class="form-control form-margin-bottom" name="confirmation_date" value="{{ old('confirmation_date') }}"  placeholder="Confirmation date...">
