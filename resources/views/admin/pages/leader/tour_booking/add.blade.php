        ...
        <div class="card shadow mb-4">
            <div class="card-header bg-default py-2 d-flex justify-content-between align-items-center">
                <h4 class="m-0 font-weight-bold text-primary">
                    <i class="fas fa-user-circle"></i>  Book a Tour
                </h4>

            </div>
            <form id="ajaxForm" class="" action="{{route('tour_booking.store')}}" method="POST">
            @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <select name="gti_id" id="" class="form-control">
                                    ...
                                    @foreach ($tours as $tour)
                                        <option value="{{ @$tour->id }}">{{ @$tour->gti_name }}</option>
                                    @endforeach
                                </select>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="to" type="datetime-local" class="form-control" name="deparature_date" value=""  placeholder="">
                      ...
                      <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <input id="to" type="number" class="form-control" name="group_size" value=""  placeholder="">
                            <p id="err-to" class="mb-0 text-danger small em"></p>
                        </div>
                      </div>
                      <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <input id="to" type="number" class="form-control" name="price" value=""  placeholder="">
                            <p id="err-to" class="mb-0 text-danger small em"></p>
                        </div>
                      </div>
                    </div>
