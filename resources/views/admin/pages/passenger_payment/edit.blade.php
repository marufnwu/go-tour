...
@section('title','Passenger Payment | Edit')
    ...
    <div class="container-fluid">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Edit Passenger Payment</li>
            </ol>
        </nav>
        ...
        <div class="card shadow mb-4">
            <div class="card-header bg-primary py-3 d-flex justify-content-between align-items-center">
                <h6 class="m-0 font-weight-bold text-white">
                    <i class="fas fa fa-desktop"></i> Edit Passenger Payment
                </h6>

            </div>
            <form id="ajaxForm" class="" action="{{route('payment_passenger.update',$payments->id)}}" method="POST">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <select class="form-control form-margin-bottom" name="type_id">
                                    ...
                                    <option value="{{ $type->id }}" {{ $payments->type_id  == $type->id ? 'selected' : '' }}>{{ $type->payment_method }}</option>
                                    @endforeach
                                </select>
                                @error('type_id')
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="from" type="text" class="form-control" name="payment_references" value="{{ $payments->payment_references }}"  placeholder="Payment references...">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="from" type="date" class="form-control" name="date_of_payment" value="{{ $payments->date_of_payment }}">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input id="from" type="number" min="0" class="form-control" name="amount" value="{{ $payments->amount }}"  placeholder="Amount...">
                                @error('amount')
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <select class="form-control form-margin-bottom" name="passenger_id">
                                    ...
                                    <option value="{{ $passenger->id }}" {{ $payments->passenger_id  == $passenger->id ? 'selected' : '' }}>{{ $passenger->first_name.' '.$passenger->last_name }}</option>
                                    @endforeach
                                </select>
                                @error('passenger_id')
