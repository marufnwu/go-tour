...
<div> 
    ...
    <div class="header">
        ...
        <div class="name-img">
            ...
            <img src="{{$asset}}uploads/brochures/{{$data->profile_image_path}}" alt="Image">
        </div>
    ...
    <div class="images">
        <div class="first-image">
            <img src="{{$asset}}uploads/brochures/bottom-4.png">
            <h5>Rio jordan</h5>
        </div>
        <div class=" second-image">
            <img src="{{$asset}}uploads/brochures/bottom-3.png">
            <h5>Templo de salomon</h5>
        </div>
         <div class="third-image">
            <img src="{{$asset}}uploads/brochures/bottom-2.png">
            <h5>Monte de los olivos</h5>
        </div>
        <div class="fourth-image ">
            <img src="{{$asset}}uploads/brochures/bottom-1.png">
...
<style>
    * {
    ...
    .header {
        height: 40%;
        width: 100%;
        background-image: url("{{$asset}}uploads/brochures/cover.png");
    ...
    .body {
        ...
        background-image: url("{{$asset}}uploads/brochures/body.png");
        background-size:cover;
    }
