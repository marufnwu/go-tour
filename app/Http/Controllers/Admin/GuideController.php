...
class GuideController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.pages.guide.add',compact('countries'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if(!$is_exist) {
            ...
            $valideData = $request->validate([
                'guide_first_n' => 'required | min:2',
                'guide_l_name' => 'required | min:2',
                'guide_address' => 'required | min:5',
                'guide_city' => 'required | min:2',
                'guide_country' => 'required | min:5',
                'guide_phone' => 'required | min:5 | numeric',
                'guide_email' => 'required | email',
                'password' => 'required | min:5 ',
                'guide_fees_per_day' => 'required | min:0 | numeric',
            ]);
            ...
            if ($request->hasFile('image')) {
                ...
                $croppedImage->save(public_path('uploads/guide-profile/' . $filename));
    ...
    public function edit($id)
    {
        ...
        if (auth()->user()->type == 'Admin') {
            ...
            $guides = Guide::where('guide_email','=',$userMail)->first();
        }
        ...
        return view('admin.pages.guide.edit', compact('guides','countries'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->hasFile('image')) {
            ...
            File::delete(public_path('uploads/guide-profile/'.$guides->image));
            ...
            $guides->image= str_replace('public/uploads/guide-profile/','',$filename);
        }
        ...
        $updateUser->name = $request ->input('guide_first_n');
        $updateUser->phone = $request ->input('guide_phone');
        $updateUser->image =  $guides ->image;

        if ($request ->input('guide_email')) {
            $updateUser->email = $request ->input('guide_email');
        }
        ...
        if(auth()->user()->type == 'Admin'){
            ...
            Session::flash('success', 'guide Information has been Updated Successfully');
            return Redirect::route('guide.edit',$guides);
        }
    }
    ...
    public function destroy($id)
    {
        ...
        $user = User::where('email','=',$guides->guide_email)->first();
