...
class DayItineraryController extends Controller
{
    ...
    public function create(Tour $tour)
    {
        ...
        return view('admin.pages.tour_management.day_itinerary.add', compact(
            'cities',
            'countries',
            'tour',
            'airports',
    ...
    public function store(Request $request, Tour $tour)
    {
        ...
        TourItinerary::create([
            'tour_id' => $tour->id,
            'dayitinerary_id' => $itineraries->id,
            'day_no' => $itineraries->day_itinerary,
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(Request $request, Tour $tour, TourItinerary $tourItinerary)
    {
